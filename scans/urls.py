...
urlpatterns = [
    ...
    # ex: /scans/api/v1/retest/33
    url(r'^api/v1/retest/(?P<finding_id>[0-9]+)$', apis.add_retest_finding_scan_def_api, name='add_retest_finding_scan_def_api'),
    # ex: /scans/api/v1/evaluate_assets/33
    url(r'^api/v1/evaluate_assets/(?P<scan_id>[0-9]+)$', apis.evaluate_assets, name='scan_evaluate_assets_api'),
